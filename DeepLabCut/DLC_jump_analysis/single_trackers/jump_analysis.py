...
single_tracker_nose_csv = 'single-tracker_jump-nose.csv'
single_tracker_rump_csv = 'single-tracker_jump-rump.csv'


nose_csv_list = [single_tracker_nose_csv]
rump_csv_list = [single_tracker_rump_csv]


def main(single_tracker_nose_csv, single_tracker_rump_csv):
...
main(nose_csv_list, rump_csv_list)
